...
<%@ taglib prefix="lins" uri="http://lins.com"%>
<%
...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">Lin-SSM-CRM系统</a>
		</div>
		<!-- /.navbar-header -->
		...
		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-messages">
					<li><a href="#">
							<div>
								<strong>林泽佳</strong> <span class="pull-right text-muted">
									<em>昨天</em>
								</span>
							</div>
							<div>未完成功能</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<lins:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
